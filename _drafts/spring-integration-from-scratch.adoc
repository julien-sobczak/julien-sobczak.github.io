...
image::{{ '/posts_resources/2016-04-11-spring-integration-from-scratch/channels.png' | prepend: site.baseurl}}[Channel implementations]
...
image::{{ '/posts_resources/2016-04-11-spring-integration-from-scratch/consumers.png' | prepend: site.baseurl}}[Message Consumers]

Both consumer types delegates internally to an instance of `MessageHandler`:

image::{{ '/posts_resources/2016-04-11-spring-integration-from-scratch/handlers.png' | prepend: site.baseurl}}[Message Handlers]
